...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOSOLOGY_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOSOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOSOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOSOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOSOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOSOLOGY actions', async () => {
      const expectedActions = [
        {
